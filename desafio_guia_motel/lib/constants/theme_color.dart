...
class ThemeColor {
  ...
  static const blueColor = Color(0xFF133a63);
  static const primaryColor = Color(0xFFB9201E);
  static const secundaryColor = Color(0xFF000000);
  ...
  static const greenColor = Color(0xFF009C34);
